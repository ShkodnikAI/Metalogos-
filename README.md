...
├── REFERENCE.md                      # Full builtin reference (~222 KB) — 100% of the registry (§6 index + №316 classification)
├── CHANGELOG.md                      # Version history (~281 KB)
...
│
├── examples/                          # 218 .mlog programs (golden corpus)

...
| Compiler | Bytecode, 399 builtins indexed | 1 516 |
...
| Built-in functions | 399 functions across 37 modules | ~18 000 |
...
├── logo.jpg                          # Brand logo
├── README.md                         # This file
├── REFERENCE.md                      # Full builtin reference (~163 KB) — 100% of the registry (§6 index)
├── CHANGELOG.md                      # Version history (~191 KB)
...
│   │
│   └── builtins/                      # 399 built-in functions (37 modules)
...
All 8 milestones and 8+ phases complete, plus a full native SVG/graphics subsystem (naryads №77-92). 122+ development narads (work orders) delivered. 399 builtins, 144 test files, 214 example programs, 129 ADRs. See [GitHub](https://github.com/ShkodnikAI/Metalogos-/commits/main) for live commit count.

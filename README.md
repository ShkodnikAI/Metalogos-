...
| Compiler | Bytecode, 435 builtins indexed | 1 516 |
...
| Built-in functions | 435 functions across 41 modules | ~18 000 |
...
├── REFERENCE.md                      # Full builtin reference (~235 KB) — 100% of the registry (§6 index + №316 classification)
...
│   │
│   └── builtins/                      # 435 built-in functions (41 modules)
...
| Built-in Functions | 435 (41 modules) |
...
All 8 milestones and 8+ phases complete, plus a full native SVG/graphics subsystem (naryads №77-92). 124+ development narads (work orders) delivered. 435 builtins, 176 test files, 226 example programs, 156 ADRs (149 accepted + 7 reserved; ADR-0154/0161 filled by naryads №322/№325; ADR-0162 — №331 media handles; ADR-0163 — №333 backend registry; ADR-0164 — №332 perception origin chain). See [GitHub](https://github.com/ShkodnikAI/Metalogos-/commits/main) for live commit count.

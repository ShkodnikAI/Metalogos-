...
[![Version](https://img.shields.io/badge/v0.20.1-blue.svg)](https://github.com/ShkodnikAI/Metalogos-/releases)
...
```
Metalogos-/
├── Cargo.toml                       # v0.20.1, workspace root
├── logo.jpg                          # Brand logo
├── README.md                         # This file
...
├── CHANGELOG.md                      # Version history (~388 KB)

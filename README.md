...
├── REFERENCE.md                      # Full builtin reference (~221 KB) — 100% of the registry (§6 index + №316 classification)
├── CHANGELOG.md                      # Version history (~278 KB)
...
│
├── examples/                          # 217 .mlog programs (golden corpus)

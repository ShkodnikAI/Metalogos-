...
| Compiler | Bytecode, 376 builtins indexed | 1 516 |
...
| Built-in functions | 376 functions across 36 modules | ~18 000 |
...
│   │
│   └── builtins/                      # 376 built-in functions (36 modules)
...
│
├── examples/                          # 209 .mlog programs (golden corpus)
...
All 8 milestones and 8+ phases complete, plus a full native SVG/graphics subsystem (naryads №77-92). 122+ development narads (work orders) delivered. 376 builtins, 70 test files, 209 golden-file examples, 117 ADRs. See [GitHub](https://github.com/ShkodnikAI/Metalogos-/commits/main) for live commit count.

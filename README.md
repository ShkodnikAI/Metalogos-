...
[![Version](https://img.shields.io/badge/v0.23.0-blue.svg)](https://github.com/ShkodnikAI/Metalogos-/releases)
...
```
Metalogos-/
├── Cargo.toml                       # v0.23.0, workspace root
├── logo.jpg                          # Brand logo
├── README.md                         # This file
...
├── CHANGELOG.md                      # Version history (~431 KB)

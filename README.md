...
| Compiler | Bytecode, 403 builtins indexed | 1 516 |
...
| Built-in functions | 403 functions across 38 modules | ~18 000 |
...
├── logo.jpg                          # Brand logo
├── README.md                         # This file
├── REFERENCE.md                      # Full builtin reference (~174 KB) — 100% of the registry (§6 index)
├── CHANGELOG.md                      # Version history (~204 KB)
...
│   │
│   └── builtins/                      # 403 built-in functions (38 modules)
...
| Built-in Functions | 403 (38 modules) |
...
All 8 milestones and 8+ phases complete, plus a full native SVG/graphics subsystem (naryads №77-92). 122+ development narads (work orders) delivered. 403 builtins, 147 test files, 214 example programs, 129 ADRs. See [GitHub](https://github.com/ShkodnikAI/Metalogos-/commits/main) for live commit count.

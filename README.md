...
├── CHANGELOG.md                      # Version history (~276 KB)
...
│
├── examples/                          # 216 .mlog programs (golden corpus)

...
[![Version](https://img.shields.io/badge/v0.21.0-blue.svg)](https://github.com/ShkodnikAI/Metalogos-/releases)
...
```
Metalogos-/
├── Cargo.toml                       # v0.21.0, workspace root
├── logo.jpg                          # Brand logo
├── README.md                         # This file
...
├── REFERENCE.md                      # Full builtin reference (~265 KB) — 100% of the registry (§6 index + №316 classification)
├── CHANGELOG.md                      # Version history (~413 KB)
...
│
├── examples/                          # 252 .mlog programs (golden corpus)

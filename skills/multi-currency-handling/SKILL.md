...
description: Convert between currencies using historical rates, manage exchange rate risk, hedging basics. Use when transactions span multiple currencies.
tier: 2
status: placeholder
---

# multi-currency-handling — PLACEHOLDER

...
pub static BUILTIN_CLASSES: &[BuiltClassEntry] = &[
    ...
    BuiltClassEntry { name: "media_meta", class: BuiltClass { role: Role::Source, default_label: Label::Public, reversibility: Reversibility::Pure, rationale: "reads media store METADATA only (kind/conf/refs/sealed) — no bytes leave the store" } },

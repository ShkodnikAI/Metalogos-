...
pub static BUILTIN_CLASSES: &[BuiltClassEntry] = &[
    ...
    BuiltClassEntry { name: "vision_export_raw", class: BuiltClass { role: Role::Sink, default_label: Label::Internal, reversibility: Reversibility::Reversible, rationale: "explicit unsigned egress opt-out (loud Warning per ADR-0125)" } },
